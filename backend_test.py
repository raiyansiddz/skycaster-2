...
class SKYCASTERAPITester:
    ...
    def test_create_api_key(self):
        ...
        headers = {'Authorization': f'Bearer {self.token}'}
        success, data, status = self.make_request('POST', '/api/v1/api_keys', 
    ...
    def test_usage_analytics(self):
        ...
        headers = {'Authorization': f'Bearer {self.token}'}
        success, data, status = self.make_request('GET', '/api/v1/usage', headers=headers)
    ...
    def test_admin_get_api_keys(self):
        ...
        headers = {'Authorization': f'Bearer {admin_token}'}
        params = {'limit': 10, 'skip': 0}
        success, data, status = self.make_request('GET', '/api/v1/admin/api_keys', headers=headers, params=params)
    ...
    def test_admin_get_support_tickets(self):
        ...
        headers = {'Authorization': f'Bearer {admin_token}'}
        params = {'limit': 10, 'skip': 0}
        success, data, status = self.make_request('GET', '/api/v1/admin/support_tickets', headers=headers, params=params)
...
def main():
    ...
    base_url = "https://36714c42-2f1b-4a6f-ba27-745e116ebf0f.preview.emergentagent.com"
